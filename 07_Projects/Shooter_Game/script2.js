...
window.addEventListener("keydown", (e) => {
  ...
  switch (e.key) {
    case "ArrowLeft":
      ...
      movement2 = setInterval(move_xN, time_period2, 2);
      break;

    case "ArrowRight":
      clearInterval(movement2);
      movement2 = setInterval(move_xP, time_period2, 2);
      break;

    case "ArrowUp":
      clearInterval(movement2);
      movement2 = setInterval(move_yP, time_period2, 2);
      break;

    case "ArrowDown":
      clearInterval(movement2);
      movement2 = setInterval(move_yN, time_period2, 2);
      break;

    case "A":
    case "a":
      clearInterval(movement1);
      movement1 = setInterval(move_xN, time_period1, 1);
      break;

    case "D":
    case "d":
      clearInterval(movement1);
      movement1 = setInterval(move_xP, time_period1, 1);
      break;

    case "W":
    case "w":
      clearInterval(movement1);
      movement1 = setInterval(move_yP, time_period1, 1);
      break;

    case "S":
    case "s":
      clearInterval(movement1);
      movement1 = setInterval(move_yN, time_period1, 1);
      break;
