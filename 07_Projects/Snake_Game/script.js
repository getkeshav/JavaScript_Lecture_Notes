...
let time_period = 500; //time to move a unit for the snake(more the value, lesser the speed)
...
// function isDead (d = playgroundSize) {
//     if 
// }
